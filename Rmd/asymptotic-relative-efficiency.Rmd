...
outcomes_scores1 <- compute_scores(outcomes, par, 1000, 1000)
outcomes_scores2 <- compute_scores2(outcomes, par, 1000, 1000)
...
jacobian <- function(score, theta, eps=1e-4){
  pq <- length(theta)
...
A <- - jacobian(score_to_derive, theta, eps=1e-1)
